...
{
    /// <inheritdoc />
    public partial class FinalSqliteSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningHours = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSpecialOfTheDay = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodItems_Canteens_CanteenId",
                        column: x => x.CanteenId,
                        principalTable: "Canteens",
                        principalColumn: "CanteenId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_DailyMenus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "DailyMenus",
                        principalColumn: "MenuId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItems_FoodItems_ItemId",
                        column: x => x.ItemId,
                        principalTable: "FoodItems",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "d125130b-d248-4395-8178-01124e5251a4", 0, "f286828a-1a3b-4c4f-a719-7f51a4e21a2c", "admin@canteen.com", true, false, null, "ADMIN@CANTEEN.COM", "ADMIN@CANTEEN.COM", "AQAAAAIAAYagAAAAENjEUf9NPn547Hr3vaHhcCS0UwWEITdpXLsLgO+kd1/n5dCZmZjCNyvrn5s2hhpCsw==", null, false, "0a5a51c4-118d-4f11-9a74-9f20e4b868e4", false, "admin@canteen.com" });

            migrationBuilder.InsertData(
                table: "Canteens",
                columns: new[] { "CanteenId", "Location", "Name", "OpeningHours" },
                values: new object[,]
                {
                    { 1, "Tầng 1, Tòa nhà C", "Nhà ăn C1", "07:00 - 19:00" },
                    { 2, "Tầng 2, Tòa nhà B", "Nhà ăn B2", "07:00 - 19:00" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Các món ăn no", "Món Chính" },
                    { 2, "Các món ăn kèm hoặc ăn vặt", "Món Phụ" },
                    { 3, "Các loại nước giải khát", "Đồ Uống" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMenus_MenuDate_CanteenId",
                table: "DailyMenus",
                columns: new[] { "MenuDate", "CanteenId" },
                unique: true);
