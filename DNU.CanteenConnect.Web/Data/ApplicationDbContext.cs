    ...
    public class ApplicationDbContext : IdentityDbContext<User, Role, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FoodItem>().HasData(
                new FoodItem { ItemId = 1, Name = "Cơm Gà Xối Mỡ", Description = "Cơm nóng hổi ăn kèm gà xối mỡ giòn tan", Price = 45000, ImageUrl = "https://topchuan.com/wp-content/uploads/2023/04/Com-Ga-Xoi-Mo-77-1.jpg", FoodCategoryCategoryId = 1, IsAvailable = true, IsSpecialOfTheDay = true, CanteenId = 1 },
                new FoodItem { ItemId = 2, Name = "Phở Bò", Description = "Phở truyền thống với thịt bò tươi", Price = 40000, ImageUrl = "https://cdn.tgdd.vn/Files/2017/03/18/962092/an-lien-3-bat-pho-voi-cong-thuc-nau-pho-nay-202201261419401397.jpg", FoodCategoryCategoryId = 1, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 },
                new FoodItem { ItemId = 3, Name = "Trà Sữa Trân Châu Đường Đen", Description = "Trà sữa thơm ngon với trân châu đường đen dẻo dai", Price = 25000, ImageUrl = "https://cdn.tgdd.vn/Files/2022/01/21/1412109/huong-dan-cach-lam-tra-sua-tran-chau-duong-den-202201211522033706.jpg", FoodCategoryCategoryId = 3, IsAvailable = true, IsSpecialOfTheDay = true, CanteenId = 1 },
                new FoodItem { ItemId = 4, Name = "Bánh Mì Kẹp", Description = "Bánh mì giòn rụm kẹp thịt và rau tươi", Price = 20000, ImageUrl = "https://tapchiamthuc.net/wp-content/uploads/2023/03/banh-mi-kep-viet-nam-17.jpg", FoodCategoryCategoryId = 2, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 },
                new FoodItem { ItemId = 5, Name = "Mì Ý Sốt Bò Băm", Description = "Mì Ý với sốt bò băm đậm đà", Price = 50000, ImageUrl = "https://cdn.tgdd.vn/Files/2019/04/15/1160777/cach-lam-mi-spaghetti-sot-bo-bam-trong-3-phut-voi-panzani-202203031421227202.jpg", FoodCategoryCategoryId = 1, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 },
                new FoodItem { ItemId = 6, Name = "Nước Cam Ép", Description = "Nước cam ép tươi nguyên chất", Price = 18000, ImageUrl = "https://tse3.mm.bing.net/th?id=OIP.BMSD4FVGoFVZDnP6_0gYoQHaEk&pid=Api&P=0&h=180", FoodCategoryCategoryId = 3, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 },
                new FoodItem { ItemId = 7, Name = "Nem Lụi", Description = "Nem lụi thơm ngon, ăn kèm nước chấm đặc biệt", Price = 35000, ImageUrl = "https://statics.vinpearl.com/nem-lui-nha-trang-07_1630987697.jpeg", FoodCategoryCategoryId = 2, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 },
                new FoodItem { ItemId = 8, Name = "Bún Chả", Description = "Bún chả Hà Nội trứ danh", Price = 42000, ImageUrl = "https://tse2.mm.bing.net/th?id=OIP.0M4f-v1qaFU6jzyxobA9QAHaFj&pid=Api&P=0&h=180", FoodCategoryCategoryId = 1, IsAvailable = true, IsSpecialOfTheDay = false, CanteenId = 1 }
            );
